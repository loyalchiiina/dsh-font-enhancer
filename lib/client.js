// dsh-font-enhancer — client bundle
// Per-region font/color styling for DSH Desktop UI.
// This file is a __ModuleLoader__ bundle served at /plugins/dsh-font-enhancer/client.js.
// Edits to this file take effect immediately when the runtime copy is synced
// (no build step, no refresh needed for the panel itself).
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    // Plugin version, kept in sync with package.json for diagnostics.
